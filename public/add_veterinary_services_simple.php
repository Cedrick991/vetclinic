<?php
/**
 * Simple Veterinary Services Addition
 * Adds the 12 veterinary services directly to database
 */
...
try {
    ...
    echo "<h2 style='color: green;'>✅ Success! All 12 veterinary services have been added to your database.</h2>";
